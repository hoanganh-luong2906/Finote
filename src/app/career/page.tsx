				...
				<div className='container'>
					<div className='row justify-content-between align-items-center'>
						<div className='col-xl-5 mil-mb-80'>
							<h2 className='mil-mb-30 mil-up'>Be part of our Team of Experts</h2>
							<p className='mil-text-m mil-soft mil-mb-60 mil-up'>
								Explore exciting opportunities and discover how your career can flourish at Finote.
							</p>
								...
								<li>
									<div className='mil-up'>
										...
										<p className='mil-text-m mil-soft'>
											At Finote, we foster an environment of constant innovation. Here, your
											creativity and passion combine to drive industry-leading solutions.
										</p>
									</div>
								</li>
								<li>
									<div className='mil-up'>
										...
										<p className='mil-text-m mil-soft'>
											We offer opportunities for continued professional development. At Finote, you
											not only work on your job, but on your career. Training, mentoring and
											significant challenges await you.
										</p>
									</div>
								</li>
							</ul>
				...
				<div className='container'>
					<div className='mil-text-center'>
						<h2 className='mil-mb-60 mil-up'>
							Explore Career <br />
							Opportunities at Finote
						</h2>
					</div>
					<div className='mil-vacancie mil-mb-30 mil-up'>
						<div className='mil-left'>
							<h4 className='mil-mb-30'>International Business Development Specialist</h4>
							<p className='mil-text-m mil-soft mil-mb-30'>
								Develop and execute strategies to expand our presence in new international markets.
							</p>
						...
						<div className='mil-right mil-up'>
							<Link href='career-details' className='mil-btn mil-m mil-add-arrow'>
								See position
							</Link>
						</div>
					</div>
