...
const page = () => {
	return (
		<PageLayout noFooter>
			<PageBanner pageName='Register' title='Register with Finote:' />
			{/* register form */}
				...
				<div className='container'>
					<div className='row justify-content-center'>
						<div className='col-xl-5'>
							<form>
								<input className='mil-input mil-up mil-mb-15' type='text' placeholder='Full name' />
								<input
								...
								<p className='mil-text-xs mil-text-center mil-soft mil-mb-30'>Or Register with:</p>
								<div className='mil-up mil-mb-15'>
									<a href='#.' className='mil-btn mil-md mil-grey mil-fw mil-mb-30'>
										Sign up with Google
									</a>
								</div>
